...
```
 ...
 Search overlay         99600     fixed       Viewport
 ...
 ─── page-level ────────────────────────────────────────────────
 Toast notifications    5000      fixed       Viewport
...
### 99600 — Search Overlay

| Element | Selector | File | Line |
|---------|----------|------|------|
| Search overlay | `.search-overlay` (inline style) | `src/features/search/components/SearchDialog.tsx` | — |

- **Position:** `fixed` — covers entire viewport
- **Trigger:** Click search icon or `Ctrl+K` / `Cmd+K`
- **WHY 99600:** Must float above account dropdown (99560) and all nav elements. Always-dark overlay matching navbar styling.
...
| Element | Selector | File | Line |
|---------|----------|------|------|
| Toast container | `.toast-container` | `src/features/notifications/components/ToastContainer.tsx` | — |

- **Position:** `fixed` — bottom-right corner of viewport
- **Trigger:** Vault add/remove actions
- **WHY 5000:** Must be above page content and sticky ads (1000) but well below navbar (95000) and overlays (99000+). Falls in the "Page-level" band.
