...
>
> **ARCHIVED 2026-03-06:** This audit was written before the position-based restructure (22 campaigns → 3 positions). The 22-campaign registry, GPT/native providers, `AD_REGISTRY`, and campaign-based naming no longer exist. Remaining open findings (F2, F8, F9) are tracked in [../04-features/ads-plan.md](../04-features/ads-plan.md). All other findings have been resolved or are no longer applicable.
...
| `src/features/ads/README.md` | 39 | Feature documentation |
