/***************************************************************
  ...
  • Index Color dropdown only affects “logo_index” (and when called via the macro).

  Additions in this version:
    • Updated preset list + live preset notes:
        - New presets (all canvas expansion locked to 0):
            logo_color → W, original color.
            logo_white → W, force white.
            logo_black → W, force black.
            logo_index → W, uses "Index Color" menu (normal/white/black/#dddad5).
            logo_text_black → W, force black.
            logo_text_white → W, force white.
            logo_text_white_2 → W, force #dddad5.
            logo_text_black_vertical -> H, rotate -90 deg, force black.
            logo_text_white_vertical → H, rotate -90°, force white.
            logo_text_white_2_vertical → H, rotate -90°, force #dddad5.
        - Two macro presets at the top:
            all_main_logo_presets → runs: logo_color, logo_white, logo_black, logo_index.
            all_text_logo_presets → runs: logo_text_black, logo_text_white,
                                      logo_text_white_2, logo_text_black_vertical,
                                      logo_text_white_vertical, logo_text_white_2_vertical.
    • NEW "Index Color" dropdown (normal / force white / force black / force #dddad5):
        - Only enabled when the selected preset is "logo_index" OR the macro "all_main_logo_presets".
        - When enabled, it controls the recolor used for the "logo_index" outputs.
...
(function () {
    ...
    var PRESET_BASENAMES = [
        ...
        "logo_text_white",
        "logo_text_white_2",
        "logo_text_black_vertical",
        "logo_text_white_vertical",
        "logo_text_white_2_vertical"
    ];
    ...
    var PRESET_INFO = {
        "logo_color": {
            ...
            brand: true,
            note: "Width-based original color; canvas expansion locked to 0."
        },
        "logo_white": {
            mode: "W",
        ...
        "logo_index": {
            ...
            brand: true,
            note: "Width-based; recolor is controlled by the 'Index Color' menu (normal/white/black/#dddad5). Canvas expansion locked to 0."
        },
        "logo_text_black": {
            mode: "W",
            colorMode: "forceBlack",
        ...
        "all_main_logo_presets": {
            children: ["logo_color", "logo_white", "logo_black", "logo_index"],
            note: "Runs all main-logo presets: logo_color, logo_white, logo_black, logo_index (logo_index uses the 'Index Color' menu)."
        },
        "all_text_logo_presets": {
            children: [
                "logo_text_black",
    ...
    function applyPresetToUI(presetNameInput) {
        ...
        indexGrp.enabled = (resolvedName === "logo_index" || resolvedName === "all_main_logo_presets");
    ...
    if (!isMacro) {
        ...
        if (resolvePresetName(mainName) === "logo_index") {
