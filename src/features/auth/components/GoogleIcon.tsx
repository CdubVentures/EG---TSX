/**
 * GoogleIcon.tsx — Google "G" logo SVG for auth buttons.
 * Extracted from MainLayout.astro auth popup markup.
 */

export default function GoogleIcon() {
  return (
    <svg
      className="w-[1.5em] h-[1.5em] shrink-0 pointer-events-none"
      width="20"
      height="20"
      aria-hidden="true"
      focusable="false"
