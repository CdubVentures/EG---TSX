...
description: >-
  Valve has revealed the Steam Machine living-room PC, second-generation Steam
  Controller, and Steam Frame standalone VR headset – all arriving early 2026
  and built around a unified SteamOS experience that lets your library travel
  between handheld, couch, and VR.
tags:
  - valve
  - steam machine
  - steam controller
...
{{{images
  [[grid cols=3 aspect=4/3 text_outside=true]]
  [alt="Valve Steam Machine 2026 cube in black with subtle light ring"]steam-machine-cube-front
  [alt="New Steam Controller 2026 showing dual analog sticks and large trackpads"]new-steam-controller-full
  [alt="Steam Frame standalone VR headset with controllers"]steam-frame-headset-controllers
...
If you’re building or upgrading a TV setup, pair it with any of the OLED or Mini-LED panels in our [best 4K gaming monitors guide](https://eggear.com/guides/monitor/best-overall) – the Machine will happily push 4K/120 with upscaling on those displays.
...
This controller is built for the couch but precise enough that many players may never reach for a mouse again when gaming from the living room. Check our [best gaming mice hub](https://eggear.com/hubs/mouse) if you still want desk precision – the new Steam Controller is the bridge device.

{{{images
  [[aspect=21/9 text_outside=true]]
  [alt="Close-up of new Steam Controller trackpads, sticks, and rear grip buttons"]new-steam-controller-detail
...
{{{images
  [[aspect=16/9 text_outside=true]]
  [alt="Steam Deck, Steam Machine, and Steam Frame connected by a single microSD card illustrating the shared library concept"]steamos-ecosystem-microsd
