...
title: >-
  ...
  far
description: >-
  Razer is reviving its iconic Boomslang as a 20th Anniversary Edition collector
  drop. Here’s what’s confirmed so far—key features, what’s in the box, and what
...
{{{images
  ...
  [alt="Side profile comparison of the original wired Boomslang (left) versus the Boomslang 20th Anniversary Edition (right), with the new model’s RGB underglow visible."]boomslang-then-now-side-profile
  [alt="Angled top view showing the original wired Boomslang next to the Boomslang 20th Anniversary Edition, highlighting the shared ambidextrous silhouette and modern RGB underglow."]boomslang-then-now-top-angle
...
The Boomslang 20th supports [**true 8,000 Hz wireless polling**](/hubs/mouse?polling_rate=8000) via Razer’s HyperPolling Wireless technology. This is the responsiveness headline: the mouse reports more often, which can reduce input latency and help cursor/aim feel “cleaner” in fast micro-corrections.
...
1) **Daily usability:** the mouse is intended to live on the dock between sessions.  
2) **Performance stack:** for Razer’s high-polling wireless ecosystem, the receiver/dock setup often matters as much as the mouse itself.
...
{{{images
  [[aspect=16/9 zoom=mag stack=true]]
  [alt="Three-quarter top view of the Boomslang 20th Anniversary Edition showing the leather-wrapped click surface and RGB underglow."]boomslang-20th-top-angle
  [alt="Front/top view of the Boomslang 20th Anniversary Edition highlighting the symmetrical shape, leather finish, and translucent green shell."]boomslang-20th-front-top
  [alt="Underside view of the Boomslang 20th Anniversary Edition showing the internal PCB through the translucent shell and the serialized collector marking."]boomslang-20th-bottom-serial
   <Images: Courtesy of Razer>
}}}
...
If you want the deeper timeline (and how sensor tech, shape trends, and esports needs changed the mouse market), read our [Gaming Mice History](/guides/mouse/gaming-mice-history).
...
{{{buttons
  ...
  text1="Notify me: Boomslang 20th Anniversary Edition"
  href1="https://www.razer.com/gaming-mice/razer-boomslang-20th-anniversary-edition"
  variant1="primary"
  target1="_blank"
  rel1="noopener"

  text2="Razer Newsroom announcement"
  href2="https://www.razer.com/newsroom/product-news/razer-boomslang-20th/"
  variant2="ghost"
  target2="_blank"
  rel2="noopener"
}}}
...
If you miss this drop (or don’t want to fight the 1,337-unit scramble), you can still get a similar “big ambi FPS” feel from plenty of mainstream wireless flagships—our [Mouse Hub](/hubs/mouse) makes it easy to compare what’s actually available right now.
...
1) Do you love the Boomslang legacy and shape enough to chase a limited collector release?
2) If you miss it, are you okay buying something more available that fits your grip and playstyle better?

{{{video "https://www.youtube.com/watch?v=VZdIHA_n3CE"}}}
